    ...
    <section className="container mx-auto px-4 md:px-16 flex flex-col lg:flex-row items-center lg:gap-20 gap-14">
      <div className="flex flex-col gap-2 flex-1">
        ...
        <h2 className=" capitalize text-3xl md:text-4xl xl:text-5xl font-bold my-3">
          ...
          <br></br>
          👉Responsive and Mobile-Friendly Design<br></br>
          👉Customizable Product Pages<br></br>
          👉SEO Optimized for Better Visibility
        </h2>
        <p className="text-lg leading-loose">
        These core features highlight Byterz Tech's commitment to delivering comprehensive,
        high-quality web development solutions tailored to meet the unique needs of your business.
        </p>
